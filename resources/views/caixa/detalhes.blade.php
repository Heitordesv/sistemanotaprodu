    ...
    <div class="card border-top border-0 border-4 border-primary">
        <div class="card-body p-4">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-3">
                ...
                <div>
                    <a href="{{ route('caixa.list') }}" class="btn btn-light btn-sm">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="card bg-light-primary shadow-none border">
                        <div class="card-body">
                            <h6 class="text-primary">Total de vendas</h6>
                            <h3 class="mb-0">{{ sizeof($vendas) }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card bg-light-success shadow-none border">
                        <div class="card-body">
                            <h6 class="text-success">Valor de abertura</h6>
                            <h3 class="mb-0">
                                R$ {{ __moeda($abertura->valor) }}
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card bg-light-warning shadow-none border">
                        <div class="card-body">
                            <h6 class="text-warning">Dinheiro em caixa</h6>
                            <h3 class="mb-0">
                                R$ {{ __moeda($abertura->valor_dinheiro_caixa) }}
                            </h3>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                            ...
                                            @if(isset($item->fatura) && count($item->fatura) > 0)
                                                ...
                                                @foreach($item->fatura as $f)
                                                    ...
                                                    <div style="font-size: 12px">
                                                        ...
                                                        • {{ $item->getTipoPagamento($f->forma_pagamento) }}
                                ...
                                <td>
                                    {{ $item->numero_nfe > 0 ? $item->NFcNumero : '--' }}
                                </td>
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="card bg-light-info border shadow-sm h-100">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="card bg-light-danger border shadow-sm h-100">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="p-3 bg-light rounded">
                                ...
                                <h6 class="text-warning">
                                    Valor em dinheiro na gaveta
                                </h6>

                                <h3>
                                    {{ __moeda($abertura->valor_dinheiro_caixa) }}
                                </h3>
            ...
            <div class="mt-4 d-flex gap-2 flex-wrap">
                ...
                <a target="_blank"
                   ...
                   href="{{ route('caixa.imprimir', $abertura->id) }}">
                ...
                <a target="_blank"
                   class="btn btn-info"
                   href="{{ route('caixa.imprimir80', $abertura->id) }}">
